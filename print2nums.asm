...
;   IN:  AL - num1/num2 , המספרים יועברו לפרוצדורה ברגיסטרים
...
;====================================================================
;   name  –  printcoc(הפרוצדורה תדפיס כוכביות)
;   IN:  CL - מספר הכוכבית
;   OUT:   יודפסו כוכביות לפי מספר הכוכביות שקיבלנו בCL
;	EFFECTED REGISTERS : dl,  
; ===================================================================
